	...
	<div class="inner">
		<div class="top_title">
			...
			<c:if test="${travelPrivacy eq 'a' or follow eq 'Y' or writer == sessionScope.memberId }">
				<a href="/travel/scrap?travelId=${travelId}&memberId=${sessionScope.memberId}" onclick="return confirm('스크랩 하시겠습니까?')" role="button" class="share_btn"><button class="scrap">스크랩</button></a>
			</c:if>
